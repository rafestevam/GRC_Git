	...
	protected void execute() throws JobAbortException, JobWarningException {
		...
		while (it.hasNext()) {
			...
			try {
				...
				IEnumAttribute issueCreatorStatusTypeList = iroUpdObj.getAttribute(IIssueAttributeType.ATTR_CREATOR_STATUS);
				...
				if ( issueActionType == CustomEnumerations.ISSUE_ACTION_TYPE.actiontype2 ) {
					 ...
					 */
					 ...
					 if ( actualDate.after(issuefinalDateSLA) && 
						...
						IListAttribute iroList = iroUpdObj.getAttribute(IIssueAttributeType.LIST_ISSUERELEVANTOBJECTS);
						this.displayLog("IListAttribute iroList = iroUpdObj.getAttribute(IIssueAttributeType.LIST_ISSUERELEVANTOBJECTS)");
						...
						while (iroIterator.hasNext()) {
							...
							if ( eiRelIssueAction == CustomEnumerations.ISSUE_ACTION_TYPE.actiontype1 ) {
								...
								this.displayLog("IEnumAttribute eaRelIssueCreatorStatus = objUpdRelIssue.getAttribute( IIssueAttributeType.ATTR_CREATOR_STATUS )");
								...
								IEnumAttribute eaRelIssueOwnerStatus = objUpdRelIssue.getAttribute( IIssueAttributeType.ATTR_OWNER_STATUS );
								this.displayLog("IEnumAttribute eaRelIssueOwnerStatus = objUpdRelIssue.getAttribute( IIssueAttributeType.ATTR_OWNER_STATUS )");
