...
public class MigStep_040_Add_Risktype extends BaseMigrationStep implements IMigrationStep {
	
	public MigStep_040_Add_Risktype(String resourcePath) throws DDLMigrationException {
		// TODO Auto-generated constructor stub
		super(MigStep_040_Add_Risktype.class.getSimpleName(), resourcePath);
	}
	...
	public String getDescription() {
		// TODO Auto-generated method stub
		return "This Migration Step adds new INTEGER categderisco to the RISK tables";
		//return null;
	}
	...
	public void adaptSchema(IMapping mapping) throws DDLMigrationException{
		try {
            String addFieldSt = "";
            addFieldSt = mapping.genAddField("A_RISK_TBL", "categderisco", 1, 1);
