...
public class MigStep_160_Add_Height extends BaseMigrationStep implements IMigrationStep {
	
	public MigStep_160_Add_Height(String resourcePath) throws DDLMigrationException {
		// TODO Auto-generated constructor stub
		super(MigStep_160_Add_Height.class.getSimpleName(), resourcePath);
	}
	...
	public String getDescription() {
		// TODO Auto-generated method stub
		return "This Migration Step adds new INTEGER height to the QUOTATION tables";
		//return null;
	}
	...
	public void adaptSchema(IMapping mapping) throws DDLMigrationException{
		try {
            String addFieldSt = "";
            addFieldSt = mapping.genAddField("A_QUOTATION_TBL", "height", 1, 2);
